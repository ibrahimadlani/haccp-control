...
from app.modules.production.models import DailyMenuItem, MenuProteinType
...
async def main() -> None:
    ...
    async with AsyncSessionLocal() as s:
        ...
        for mid, meal, dish, protein, allergens in MENU_DEMO:
            await upsert(
                s,
                DailyMenuItem,
                mid,
